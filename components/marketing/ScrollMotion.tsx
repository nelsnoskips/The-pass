...
const CINE: Track[] = [
  { sel: ".mk-act-photo", yUnit: "%", kf: [[0, { s: [1.04, 1.04], y: [0, 0] }], [100, { s: [1.04, 1.28], y: [0, -3] }]] },
  ...
  { sel: ".mk-act-cta", yUnit: "px", kf: [[0, { o: [0, 0], y: [48, 48] }], [80, { o: [0, 1], y: [48, 0] }], [96, { o: [1, 1], y: [0, 0] }], [100, { o: [1, 1], y: [0, 0] }]] },
